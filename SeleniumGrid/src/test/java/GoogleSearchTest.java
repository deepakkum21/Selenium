...
import com.stpl.deepak.grid.SetupTestDriver;
...
public class GoogleSearchTest {
    ...
    public void googleUrlTest() {
    	...
    	System.out.println("googleUrlTest");
    ...
    public void googleSearchButtonTest() {
    	...
    	System.out.println("googleSearchButtonTest");
        WebElement searchButtonElement = driver.findElement(By.name("btnK"));
        Assert.assertFalse(searchButtonElement.isDisplayed());
    ...
    public void googleFeelingLuckyButtonTest() {
    	...
    	System.out.println("googleFeelingLuckyButtonTest");
        WebElement feelingLuckyElement = driver.findElement(By.name("btnI"));
        Assert.assertFalse(feelingLuckyElement.isDisplayed());
